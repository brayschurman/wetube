...
const Home: NextPage = () => {
    ...
    const createRoom = async () => {
        newRoomMutation.mutate({ name: roomName }, {
        ...
        <>
            ...
            <main className="flex min-h-screen flex-col items-center justify-center bg-black">
                <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 ">
                    ...
                    {youtubeId.length <= 0 &&
                        <div className="font-bold text-xl text-white">Watch Youtube in sync with your friends.</div>
                    }

                    {youtubeId.length > 0 &&
                        <iframe width="563" height="480" src={"https://www.youtube.com/embed/" + youtubeId} title="MinimaTube"
